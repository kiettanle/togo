...
const permissions = [
  { id: random.uuid(), name: 'Create User', resource: PermissionResource.Users, action: PermissionAction.Create },
  { id: random.uuid(), name: 'Update User', resource: PermissionResource.Users, action: PermissionAction.Update },
